 ...
 */
export abstract class AvatarAnimatedBodyPart extends AnimatedSprite implements IAvatarBodyPart {
     ...
     */
    constructor(private _animations: Texture[][], identifier: string, direction: number | null) {
        super(_animations[0]);
